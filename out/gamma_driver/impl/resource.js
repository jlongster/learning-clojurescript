...
var buffer = (function (){var or__4953__auto__ = new cljs.core.Keyword(null,"array-buffer","array-buffer",519008380).cljs$core$IFn$_invoke$arity$1(spec);
...
var buffer = (function (){var or__4953__auto__ = new cljs.core.Keyword(null,"element-array-buffer","element-array-buffer",-2099854251).cljs$core$IFn$_invoke$arity$1(spec);
if(cljs.core.truth_(or__4953__auto__)){
return or__4953__auto__;
} else {
return gl.createBuffer();
...
var flip_y = cljs.core.get.call(null,map__20107__$1,new cljs.core.Keyword(null,"flip-y","flip-y",935998815));
if(!((flip_y == null))){
...
var map__20109 = spec;
var map__20109__$1 = ((cljs.core.seq_QMARK_.call(null,map__20109))?cljs.core.apply.call(null,cljs.core.hash_map,map__20109):map__20109);
var s = cljs.core.get.call(null,map__20109__$1,new cljs.core.Keyword(null,"s","s",1705939918));
var t = cljs.core.get.call(null,map__20109__$1,new cljs.core.Keyword(null,"t","t",-1397832519));
if(cljs.core.truth_(s)){
...
var map__20111 = spec;
var map__20111__$1 = ((cljs.core.seq_QMARK_.call(null,map__20111))?cljs.core.apply.call(null,cljs.core.hash_map,map__20111):map__20111);
var min = cljs.core.get.call(null,map__20111__$1,new cljs.core.Keyword(null,"min","min",444991522));
var mag = cljs.core.get.call(null,map__20111__$1,new cljs.core.Keyword(null,"mag","mag",48619174));
...
var format_type = cljs.core.get.call(null,map__20115__$1,new cljs.core.Keyword(null,"format-type","format-type",-23280096));
var width = cljs.core.get.call(null,map__20115__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__20115__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var unpack = cljs.core.get.call(null,map__20115__$1,new cljs.core.Keyword(null,"unpack","unpack",-2027067542));
var filter = cljs.core.get.call(null,map__20115__$1,new cljs.core.Keyword(null,"filter","filter",-948537934));
var wrap = cljs.core.get.call(null,map__20115__$1,new cljs.core.Keyword(null,"wrap","wrap",851669987));
var vec__20116 = format_type;
var format = cljs.core.nth.call(null,vec__20116,(0),null);
var type = cljs.core.nth.call(null,vec__20116,(1),null);
var format__$1 = gamma_driver.impl.resource.texture_formats.call(null,(function (){var or__4953__auto__ = format;
if(cljs.core.truth_(or__4953__auto__)){
return or__4953__auto__;
} else {
...
var type__$1 = gamma_driver.impl.resource.texture_data_types.call(null,(function (){var or__4953__auto__ = type;
if(cljs.core.truth_(or__4953__auto__)){
return or__4953__auto__;
} else {
...
var G__20117_20118 = (((gamma_driver.impl.resource.texture_data_type.call(null,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(spec)) instanceof cljs.core.Keyword))?gamma_driver.impl.resource.texture_data_type.call(null,new cljs.core.Keyword(null,"data","data",-232669377).cljs$core$IFn$_invoke$arity$1(spec)).fqn:null);
switch (G__20117_20118) {
case "image":
...
var map__20121 = spec;
var map__20121__$1 = ((cljs.core.seq_QMARK_.call(null,map__20121))?cljs.core.apply.call(null,cljs.core.hash_map,map__20121):map__20121);
var width = cljs.core.get.call(null,map__20121__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.call(null,map__20121__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var format = cljs.core.get.call(null,map__20121__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
...
gamma_driver.impl.resource.frame_buffer_attachment = (function gamma_driver$impl$resource$frame_buffer_attachment(gl,fb,p__20122){
var vec__20125 = p__20122;
var attachment = cljs.core.nth.call(null,vec__20125,(0),null);
var attachment_point = cljs.core.nth.call(null,vec__20125,(1),null);
var G__20126 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(attachment) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(attachment).fqn:null);
switch (G__20126) {
case "texture":
...
var map__20130 = spec;
var map__20130__$1 = ((cljs.core.seq_QMARK_.call(null,map__20130))?cljs.core.apply.call(null,cljs.core.hash_map,map__20130):map__20130);
var color = cljs.core.get.call(null,map__20130__$1,new cljs.core.Keyword(null,"color","color",1011675173));
var depth = cljs.core.get.call(null,map__20130__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var stencil = cljs.core.get.call(null,map__20130__$1,new cljs.core.Keyword(null,"stencil","stencil",-1049110946));
var depth_stencil = cljs.core.get.call(null,map__20130__$1,new cljs.core.Keyword(null,"depth-stencil","depth-stencil",-221852810));
gl.bindFramebuffer(goog.webgl.FRAMEBUFFER,fb);

cljs.core.dorun.call(null,cljs.core.map.call(null,((function (fb,map__20130,map__20130__$1,color,depth,stencil,depth_stencil){
return (function (p1__20128_SHARP_){
return gamma_driver.impl.resource.frame_buffer_attachment.call(null,gl,fb,p1__20128_SHARP_);
});})(fb,map__20130,map__20130__$1,color,depth,stencil,depth_stencil))
...
var G__20132 = (((new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(spec) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(spec).fqn:null);
switch (G__20132) {
case "program":
