...
gamma.compiler.move_assignments.helper = (function gamma$compiler$move_assignments$helper(db,location){
...
gamma.compiler.move_assignments.move_assignments = (function gamma$compiler$move_assignments$move_assignments(){
return (function (db,location){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [gamma.compiler.move_assignments.helper.call(null,db,location),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"body","body",-2049205669),gamma.compiler.common.map_path.call(null,gamma$compiler$move_assignments$move_assignments.call(null))], null)], null)], null);
});
});

//# sourceMappingURL=move_assignments.js.map