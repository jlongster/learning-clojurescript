...
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"group","group",582596132),"(",cljs.core.interpose.call(null,[cljs.core.str(" "),cljs.core.str(literal),cljs.core.str(" ")].join(''),cljs.core.map.call(null,((function (literal){
return (function (p1__20382_SHARP_){
return gamma.emit.emit.emit.call(null,db,db.call(null,p1__20382_SHARP_));
});})(literal))
...
var literal = new cljs.core.Keyword(null,"literal","literal",1664775605).cljs$core$IFn$_invoke$arity$1(gamma.ast.operators.call(null,gamma.ast.head.call(null,x)));
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"group","group",582596132),"(",[cljs.core.str(" "),cljs.core.str(literal)].join(''),gamma.emit.emit.emit.call(null,db,db.call(null,cljs.core.first.call(null,gamma.ast.body.call(null,x)))),")"], null);
}));
cljs.core._add_method.call(null,gamma.emit.emit.emit,new cljs.core.Keyword(null,"postfix","postfix",-571724593),(function (db,x){
var literal = new cljs.core.Keyword(null,"literal","literal",1664775605).cljs$core$IFn$_invoke$arity$1(gamma.ast.operators.call(null,gamma.ast.head.call(null,x)));
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"group","group",582596132),"(",gamma.emit.emit.emit.call(null,db,db.call(null,cljs.core.first.call(null,gamma.ast.body.call(null,x)))),[cljs.core.str(literal),cljs.core.str(" ")].join(''),")"], null);
}));
