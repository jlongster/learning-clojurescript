...
var temp__4421__auto__ = new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(x);
...
}),cljs.core.filter.call(null,(function (p1__20763_SHARP_){
return cljs.core.not.call(null,cljs.core.re_matches.call(null,(new RegExp("gl_.*")),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__20763_SHARP_)));
...
return gamma.emit.emit.emit.call(null,db,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"declaration","declaration",-1819933768),new cljs.core.Keyword(null,"variable","variable",-281346492),v], null));
}),cljs.core.filter.call(null,(function (p1__20764_SHARP_){
return cljs.core.not.call(null,(cljs.core.truth_(new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__20764_SHARP_))?cljs.core.re_matches.call(null,(new RegExp("gl_.*")),new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__20764_SHARP_)):null));
...
return new cljs.core.PersistentVector(null, 7, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),(function (){var temp__4421__auto__ = new cljs.core.Keyword(null,"storage","storage",1867247511).cljs$core$IFn$_invoke$arity$1(v);
if(cljs.core.truth_(temp__4421__auto__)){
...
})(),(function (){var temp__4421__auto__ = new cljs.core.Keyword(null,"precision","precision",-1175707478).cljs$core$IFn$_invoke$arity$1(v);
if(cljs.core.truth_(temp__4421__auto__)){
var p = temp__4421__auto__;
...
}catch (e20765){if((e20765 instanceof Error)){
var e = e20765;
